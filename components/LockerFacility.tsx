    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Safe Deposit Lockers</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div className="space-y-6">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-2">Maximum Security</h3>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-2">Convenient Access</h3>
                <p className="text-muted-foreground">
            ...
            <div className="flex items-start space-x-4">
              <Key className="w-8 h-8 text-secondary-foreground mt-1" />
              <div>
                <h3 className="text-xl font-semibold text-foreground mb-2">Dual Key System</h3>
                <p className="text-muted-foreground">
          ...
          {lockerSizes.map((locker, index) => (
            <Card key={index} className="text-center hover:shadow-lg transition-shadow duration-300">
              <CardContent className="p-6">
                ...
                <h3 className="text-xl font-semibold text-foreground mb-2">{locker.size} Locker</h3>
                <p className="text-muted-foreground mb-3">{locker.dimensions}</p>
                <div className="text-2xl font-bold text-primary mb-4">{locker.price}</div>
                <p className="text-sm text-muted-foreground mb-6">Ideal for: {locker.ideal}</p>
